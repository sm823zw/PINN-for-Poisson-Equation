...
# Uncomment the below three lines if you want to train the third model of the three model ensemble
# data_f = data_f.loc[(data_f['Vgs'] >= 0) & (data_f['Vgs'] <= 1)]
# data_bc1 = data_bc1.loc[(data_bc1['Vgs'] >= 0) & (data_bc1['Vgs'] <= 1)]
# data_bc2 = data_bc2.loc[(data_bc2['Vgs']>= 0) & (data_bc2['Vgs'] <= 1)]
