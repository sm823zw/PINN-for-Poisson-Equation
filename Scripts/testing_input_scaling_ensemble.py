...
model_1 = NN_SC1(2, 1, 20, 4).to(device)
model_2 = NN_SC2(2, 1, 20, 4).to(device)
model_1.load_state_dict(torch.load('../Trained Models/Scale and Ensemble/Scale alpha -1/model.pt', map_location='cuda:0'))
model_2.load_state_dict(torch.load('../Trained Models/Scale and Ensemble/Scale alpha 1/model.pt', map_location='cuda:0'))
